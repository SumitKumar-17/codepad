import { OpSeq } from "../codepad-wasm/pkg/codepad_wasm";
import type {
  editor,
  IDisposable,
  IPosition,
...
/** Options passed in to the Codepad constructor. */
export type CodepadOptions = {
  readonly uri: string;
...
class Codepad {
  ...
  constructor(readonly options: CodepadOptions) {
  ...
  /** Destroy this Codepad instance and close any sockets. */
  dispose() {
